...
I love a clean, beautiful system that doesn't get in my. I've developed this setup over the last year or two, iterating and restarting many a times. But ultimately I have found a terminal-centric workflow to be the most practical, meaning the following software is critical to my workflow:
