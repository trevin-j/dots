...
description: >
  ...
  wenyan-lite, wenyan-full, wenyan-ultra. Use when the user says "caveman mode",
...
Code/commits/PRs: write normal unless a dedicated caveman skill is active for that task. "stop caveman" or "normal mode": revert. Level persist until changed or session end.
